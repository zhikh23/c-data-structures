...
- [matrix.h](./inc/matrix.h) - матрица вещественных чисел:
  - [flat_matrix.h] - реализация `imatrix_t`, хранение элементов матрицы в едином массиве.
  - [csr_matrix.h] - реализация `imatrix_t`, разреженная матрица с построчным хранением.
