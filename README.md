...
- [astack.h](./inc/astack.h) - стек на векторе (массиве) (В РАЗРАБОТКЕ).
- [lstack.h](./inc/lstack.h) - стек на односвязанном списке (В РАЗРАБОТКЕ).
...
- [map.h](./inc/map.h) - ассоциативный массив (словарь, мапа), сопоставляющая строке - целое число:
  ...
  - [avltree.h](./inc/avltree.h) - реализация `imap_t`, сбалансированное AVL дерево (В РАЗРАБОТКЕ);
